...
const TopSection = (props: HomePageProps) => {
    return (
        <div id='home' className="bg-cover bg-no-repeat bg-right sm:bg-center md:h-screen">
            <NavBar></NavBar>
            <div className="w-full sm:w-7/12 mx-auto sm:pt-20">
                <div className="text-block pt-20 pb-20 text-center flex flex-col items-center sm:items-end">
                    ...
                    <a href="#About" className="mt-10 py-3 px-4 w-40 font-semibold text-white bg-amber-800 border-4 rounded duration-300 sm:bg-transparent hover:border-amber-800 hover:text-amber-800 hover:bg-white">View more</a>
                </div>
            </div>
        </div>
    )
